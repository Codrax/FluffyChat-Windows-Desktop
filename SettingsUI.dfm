object SettingsForm: TSettingsForm
  ...
  object Label10: TLabel
    ...
    AutoSize = False
    Caption = 
      'This is an free application developed by Codrut Software, based ' +
      'on the FluffyChat project.'#13#10#13#10'For bugs related to the FluffyChat' +
      ' client, please raise an issue on their respective repository.'
    WordWrap = True
  end
  ...
  object Label11: TLabel
    ...
    Width = 248
    Height = 15
    Caption = 'This application is based on FluffyChat version:'
  end
  ...
  object Button8: TButton
    ...
    Height = 70
    Caption = 'Support'
    CommandLinkHint = 'Codrut Software support page'
    Style = bsCommandLink
    TabOrder = 12
    WordWrap = True
  ...
  object Button5: TButton
    ...
    Width = 249
    Height = 70
    Caption = 'FluffyChat Repository'
    CommandLinkHint = 'The repository of the client this app uses'
    Style = bsCommandLink
    TabOrder = 13
    WordWrap = True
